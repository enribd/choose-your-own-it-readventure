...
# <img height="35" src="/assets/learning-paths/icons/software-architecture.png" alt="software-architecture" title="Software Architecture"/> Software Architecture Learning Path (5 :books:)
...
<sub>[#extensibility]() [#scalability]() [#clean-code]() [#ddd]() [#hexagonal-architecture]()</sub>
