...
# ![img](/assets/learning-paths/icons/eda.png){: style="height:35px"} Event Driven Architecture (EDA) Learning Path (1 :books:)
...
[**⬆ back to top**](#event-driven-architecture-(eda)-learning-path-1)
