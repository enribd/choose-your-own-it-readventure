...
- **36** books :books: , discover them all in the [:scroll: book index](/references/book-index).
- **65** authors :black_nib: , discover them all in the [:scroll: author index](/references/author-index).
